...
TEST(ProxEntropyTest, test_prox_feasible_float) {
  test_prox_entropy_feasible<float>(-3, 3, 1);
}

TEST(ProxEntropyTest, test_prox_feasible_double) {
  test_prox_entropy_feasible<double>(-6, 6, 4);
}
